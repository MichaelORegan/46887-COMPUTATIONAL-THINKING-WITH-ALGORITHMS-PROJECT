...
for r in range(num_runs):                           # looping the timing of the algorithm for num_runs
    ...
    bubbleSort(a)                                   # calling algorithm for array a
...
for r in range(num_runs):
    ...
    bubbleSort(b)                                    # calling algorithm for array b
...
for r in range(num_runs):
    ...
    c = np.random.randint(200000, size=500)          # array of size 500
    start_time = time.time_ns()
    bubbleSort(c)                                    # calling algorithm for array c
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsc = []
...
for r in range(num_runs):
    ...
    d = np.random.randint(200000, size=750)          # array of size 750
    start_time = time.time_ns()
    bubbleSort(d)                                    # calling algorithm for array d
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsd = []
...
for r in range(num_runs):
    ...
    e = np.random.randint(200000, size=1000)         # array of size 1000
    start_time = time.time_ns()
    bubbleSort(e)                                    # calling algorithm for array e
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultse = []
...
for r in range(num_runs):
    ...
    f = np.random.randint(200000, size=2500)         # array of size 2500
    start_time = time.time_ns()
    bubbleSort(f)                                    # calling algorithm for array f
    end_time = time.time_ns()
    resultsf = []
    time_elapsed = (end_time - start_time)*10**-6
...
for r in range(num_runs):
    ...
    g = np.random.randint(200000, size=5000)         # array of size 5000
    start_time = time.time_ns()
    bubbleSort(g)                                    # calling algorithm for array g
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsg = []
...
for r in range(num_runs):
    ...
    h = np.random.randint(200000, size=7500)         # array of size 7500
    start_time = time.time_ns()
    bubbleSort(h)                                    # calling algorithm for array h
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsh = []
...
for r in range(num_runs):
    ...
    i = np.random.randint(200000, size=10000)        # array of size 10000
    start_time = time.time_ns()
    bubbleSort(i)                                    # calling algorithm for array i
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsi = []
...
for r in range(num_runs):
    ...
    j = np.random.randint(200000, size=15000)        # array of size 15000
    start_time = time.time_ns()
    bubbleSort(j)                                    # calling algorithm for array j
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsj = []
...
for r in range(num_runs):
    ...
    k = np.random.randint(200000, size=20000)        # array of size 20000
    start_time = time.time_ns()
    bubbleSort(k)                                    # calling algorithm for array k
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsk = []
...
for r in range(num_runs):
    ...
    l = np.random.randint(200000, size=30000)        # array of size 30000
    start_time = time.time_ns()
    bubbleSort(l)                                    # calling algorithm for array l
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsl = []
...
for r in range(num_runs):
    ...
    m = np.random.randint(200000, size=50000)        # array of size 50000
    start_time = time.time_ns()
    bubbleSort(m)                                    # calling algorithm for array m
    end_time = time.time_ns()
    time_elapsed = (end_time - start_time)*10**-6
    resultsm = []
...
bubblebench = [ra, rb, rc, rd, re, rf, rg, rh, ri, rj, rk, rl, rm] # setting bubblebench to an array of the results of timings for sorting arrays a-m